...
<head>
	...
	<link rel="stylesheet" href="/App/Home/View/Public/Css/list.css" />
</head>
<body>
<!--头部-->
	...
	<div class='main'>
		<div class='main-left'>
			<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><dl>
				...
				<dd class='channel'><a href="<?php echo U('/show-'.$v['id']);?>"><?php echo ($v["title"]); ?></a></dd>
				<dd class='info'>
				...
				<dd class='read'>
					<a href="<?php echo U('/show-'.$v['id']);?>">阅读全文>></a>
				</dd>
