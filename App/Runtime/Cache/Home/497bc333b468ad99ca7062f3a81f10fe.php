...
<head>
	...
	<link rel="stylesheet" href="/App/Home/View/Public/Css/common.css" />
	<script type="text/JavaScript" src='/App/Home/View/Public/Js/jquery-1.7.2.min.js'></script>
	<script type="text/JavaScript" src='/App/Home/View/Public/Js/common.js'></script>
	<link rel="stylesheet" href="/App/Home/View/Public/Css/index.css" />
	</head>
<body>
<!--头部-->
	...
	<div class='top-search-wrap'>
		<div class='top-search'>
			<a href="http://www.nicewen.com" target='_blank' class='logo'>
				<img src="/App/Home/View/Public/Images/logo.gif"/>
			</a>
...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			<dl>
				<?php if(is_array($search)): foreach($search as $key=>$v): ?><dd><a href="<?php echo U('/show-'.$v['id']);?>"><?php echo ($v["title"]); ?></a></dd><?php endforeach; endif; ?>
			</dl>
		</div>
		<!--主体右侧-->
