...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/blog/App/Admin/View/Public/Css/login.css" />
		<meta http-equiv="Content-Type" content="text/html charset=utf-8" />
		<script type="text/javascript" src="/blog/App/Admin/View/Public/Js/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="/blog/App/Admin/View/Public/Js/login.js"></script>
	</head>
	<body>
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				<tr>
					<th>管理员帐号:</th>
					<td>
						<input type="text" name="name" class="len250"/>
					</td>
				</tr>
				<tr>
					<th>密码:</th>
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="text" class="len250" name="code"/> <img src="<?php echo U(MODULE_NAME.'/Login/verify');?>" id="code"/> <a href="javascript:void(change_code(this));">看不清</a>
					</td>
				</tr>
				<tr>
